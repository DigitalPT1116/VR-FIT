...
$procura="SELECT * FROM payment where payment_type like '%".$pesquisa."%'";
...
<div class="card">
     <div class="card-body" style="background-color: #007bff; color: #ffffff;">
         <div class="row">
             ...
             <div class="col-md-1">
    <a href="payment.php" class="btn btn-light ">Voltar</a>
             </div>
     ...
     <tr>
        ...
        for($i=0;$i<$num_registos;$i++)
                    while($registos = mysqli_fetch_assoc($faz_procura)) {
                        echo "<tr>";
                        echo "<td>".$registos['payment_type']."</td>";
                        echo "<td>".$registos['Amount']." €</td>";
                        echo "<td>".$registos['costumer_name']."</td>";
                        echo "</tr>";
                    }
                    ?>
        </tbody>
