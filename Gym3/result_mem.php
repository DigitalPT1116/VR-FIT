...
$procura="SELECT * FROM doctorapp where fname like '%".$pesquisa."%'";
...
<div class="card">
     <div class="card-body" style="background-color: #007bff; color: #ffffff;">
         <div class="row">
             ...
             <div class="col-md-1">
    <a href="member_details.php" class="btn btn-light ">Voltar</a>
             </div>
     ...
     <tr>
        ...
        for($i=0;$i<$num_registos;$i++)
                    while($registos = mysqli_fetch_assoc($faz_procura)) {
                        echo "<tr>";
                        echo "<td>".$registos['fname']."</td>";
                        echo "<td>".$registos['lname']."</td>";
                        echo "<td>".$registos['email']."</td>";
                        echo "<td>".$registos['docapp']."</td>";
                        echo "</tr>";
                    }
                    ?>
        </tbody>
