...
<form method="GET" action="result_paga.php">
 <div class="container">
<div class="card">
    ...
    <a href="admin-panel.php" class="btn btn-light ">Voltar</a>
             ...
             <div class="col-md-4"><h3>Informações Pagamentos</h3></div>
     ...
     <tr>
        ...
        <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>".$user_data['payment_type']."</td>";
                        echo "<td>".$user_data['Amount']."</td>";
                        echo "<td>".$user_data['customer_id']."</td>";
                        echo "<td>".$user_data['customer_name']."</td>";
                        echo "<td>
                        <a class='btn btn-sm btn-primary' href='edit_pagamentos.php?Payment_id=$user_data[Payment_id]' title='Editar'>
                            <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil' viewBox='0 0 16 16'>
                                <path d='M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z'/>
                            </svg>
                            </a> 
                            <a class='btn btn-sm btn-danger' href='apagar_pagamentos.php?Payment_id=$user_data[Payment_id]' title='Apagar'>
    ...
    <div class="card-body" style="background-color: #007bff; color: #FFF; border-color:#fff">
                <h3>Novo Pagamento</h3>
                </div> 
                <div class="card-body"></div>
                <form class="form-group" action="func.php" method="post">
                <label>ID Pagamento</label>
<input name="Payment_id" type="text" class="form-control" readonly><br>
...
<input type="submit" class="btn btn-primary" name="pay_submit" value="PAGAR" style="background-color: #007bff; border-color: #fff;">
     </div>
    </div>
    </div>
