...
<input name="contact" type="text" class="form-control" readonly><br>        
 ...
 <select class="form-control" name="docapp">
  ...
  <input type="submit" class="btn btn-primary" name="pat_submit" value="Registar">                  
				        ...
				        if (isset($_SESSION['u_id'])) {
						  echo '<form action="includes/login.php" method="POST">
							...
							echo '<form action="includes/login.php" method="POST">
				              ...
				              <a href="login.php" class="btn btn-light" style="background-color:#007bff;color:white">Logout</a>';
